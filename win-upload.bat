...
@REM git push -f https://github.com/Shuaiwen-Cui/AI-Transformer.git main
git push -f https://github.com/Shuaiwen-Cui/AI-Transformer.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/AI-Transformer.git
